...
MODEL_REGISTRY = {
    ...
    "模型B（精简体成分）": {
        ...
        "input_limits": {
            "年龄": {"min": 14.0, "max": 100.0},
            "体重指数": {"min": 10.0, "max": 70.0},
            "腰臀比": {"min": 0.5, "max": 1.5},
            "上肢脂肪百分比": {"min": 0.0, "max": 0.4},
            "下肢脂肪百分比": {"min": 0.05, "max": 0.65},
            "身体总水分/去脂体重": {"min": 0.60, "max": 0.85},
        },
        "description": "使用性别、年龄、饮酒史、BMI、腰臀比和精简体成分指标评估代谢异常风险。",
    },
    "模型C（人口学基础）": {
        "file": "model_c.pkl",
        "features": ["年龄", "饮酒史", "体重指数", "腰臀比"],
        "input_limits": {
            "年龄": {"min": 14.0, "max": 100.0},
            "体重指数": {"min": 10.0, "max": 70.0},
            "腰臀比": {"min": 0.5, "max": 1.5},
        },
        "description": "仅使用年龄、饮酒史、BMI 和腰臀比评估代谢异常风险。",
    },
}
...
with st.sidebar.expander("ℹ️ 查看模型适用信息", expanded=False):
    st.markdown(
        "**模型 A**：体格、体成分和实验室检查指标。  \n"
        "**模型 B**：性别、年龄、饮酒史、BMI、WHR和精简体成分指标。  \n"
        "**模型 C**：年龄、饮酒史、BMI和WHR。  \n"
        "各模型独立运行，并非概率融合。"
    )
